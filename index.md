...
- [Problem Definition]({{ '/problem-definition' | relative_url }})
- [Methods]({{ '/methods' | relative_url }})
- [Potential Results and Discussion]({{ '/results-discussion' | relative_url }})
...
Use this page as your landing page for GitHub Pages and complete each linked section page.
